    ...
    public class AdminsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetAdmin(int adminId)
        {
            ...
            if (dataReader.Read())
            {
                ...
                objAdmin.UserDetails.Contact = dataReader.GetInt32(3);
                objAdmin.UserDetails.Email = dataReader.IsDBNull(4) ? string.Empty : dataReader.GetString(4);
                objAdmin.UserDetails.MaritalStatus = dataReader.IsDBNull(5) ? string.Empty : dataReader.GetString(5);
                objAdmin.UserDetails.Gender = dataReader.IsDBNull(6) ? string.Empty : dataReader.GetString(6);
